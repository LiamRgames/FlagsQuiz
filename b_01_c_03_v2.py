...
class Results:
    ...
    def display_stats(self, wrong,right,total_questions_answered):
        ...
        stats_heading = Label(self.stats_frame, text="Your Results:", font=('Sans Serif', 20, 'bold'), bg='lightblue')
        total_wrong = Label(self.stats_frame,text=f"Incorrect: {wrong}", font=('Sans Serif', 10, 'bold'), bg='lightblue')
        total_right = Label(self.stats_frame,text=f"Correct: {right}", font=('Sans Serif', 10, 'bold'), bg='lightblue')
        total_questions = Label(self.stats_frame,text=f"Total Questions Answered: {total_questions_answered}", font=('Sans Serif', 10, 'bold'), bg='lightblue')
...
def check_answer(option_number):
    ...
    if questions_answered < 10:
        ...
        user_results.stats_frame.pack_forget()
