...
option1 = Button(question_frame, command=lambda: check_answer(1))
option2 = Button(question_frame, command=lambda: check_answer(2))
option3 = Button(question_frame, command=lambda: check_answer(3))
option4 = Button(question_frame, command=lambda: check_answer(4))
